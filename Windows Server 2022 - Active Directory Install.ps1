...
#--------------------------------------------------------------------------
#- Cutomized by:             Samuel Takachicha                            -
#- Version:                  1.0                                          -
#--------------------------------------------------------------------------
# Change Log                                                              -
# 1st April 2022        Customized Script for Windows Server 2022         -
#--------------------------------------------------------------------------
...
# Network Variables
$ethipaddress = '10.10.10.12' #statc IP Address of the server
$ethprefixlength = '24' # subnet mask - 24 = 255.255.255.0
$ethdefaultgw = '10.10.10.12' # default gateway
$ethdns = '8.8.8.8' # for multiple DNS you can append DNS entries with comma's
$globalsubnet = '10.10.10.0/24' # Global Subnet will be used in DNS Reverse Record and AD Sites and Services Subnet
$subnetlocation = 'Irvine'
$sitename = 'Irvine-Site' # Renames Default-First-Site within AD Sites and Services

# Active Directory Variables
$domainname = 'XROS.local' # enter in your active directory domain
...
# Hostname Variables
$computername = 'XROSDC1' # enter in your server name
...
# Log File Location
$logfile = "C:\temp\Windows-2022-AD-Deployment-log.txt"
